...
# ============================================================
# manual_complaint.py / host_complaint_dispatcher.py ile AYNI kaynak
# yapısı — tutarlılık için buraya da taşındı.
BRANDS = {
    "superbetin": {
...
# Diğer script'lerle (host_complaint_dispatcher.py, manual_complaint.py)
# aynı mantık. Safe Browsing'e bare domain yerine varsa en spesifik
# canlı kanıt URL'i (ör. /login.php) bildirilir — bu, tek başına domain
# adından daha güçlü/doğrudan kanıt niteliğinde.
# ============================================================
